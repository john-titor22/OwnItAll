...
export interface GameState {
  ...
  lastChanceCard?: { id: number; text: string; emoji: string };
  doublesStreak?: number;   // 0-2: consecutive doubles rolled by current player this turn
  parkingPot?: number;      // MAD accumulated from taxes; collected by landing on Free Parking
}
